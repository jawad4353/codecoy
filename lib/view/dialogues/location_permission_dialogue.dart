  ...
  return (await showDialog(context: context, builder:(context)=>Dialog(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        Text(AppConstants.locationRequired,style:AppTextStyles.robotoMedium(
          color: AppColors.black191B32,
          fontSize: 19.sp,
          weight: FontWeight.w600,
        )),
       SizedBox(height: 20.h,),
        Text(AppConstants.appNeedsLocation,style:AppTextStyles.robotoMedium(
          color: AppColors.black191B32,
          fontSize: 17.sp,
      ...
      SizedBox(
          height:35.h,
          child: customDialogueButton(title: AppConstants.ok, onPressed: () => Navigator.of(context).pop(false))
      ),
      ],),
    ),
