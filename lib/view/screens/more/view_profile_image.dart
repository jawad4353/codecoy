...
class ImageDisplayScreen extends StatelessWidget {
  ...
  const ImageDisplayScreen({super.key, required this.imageUrl, required this.userName});
      ...
      body: Center(
        child: imageUrl == null
          ...
          child: Text(
            ...
            style: AppTextStyles.robotoMedium(color: AppColors.primary, fontSize: 23.sp, weight: FontWeight.w400),
          ),
        )
